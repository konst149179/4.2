...
namespace RailwayApp
{
    ...
    public class Tariff
    {
        ...
        {
            if (baseCost <= 0)
                throw new ArgumentException("Стоимость не может быть отрицательной или равной 0");
            Direction = direction;
            BaseCost = baseCost;
        ...
        {
            if (Strategy is PercentageDiscount percentageDiscount)
            {
